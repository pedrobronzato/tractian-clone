...
export default function Hero({ role }: HeroProps) {
  ...
  return (
    <>
      ...
      >
        <div className="3xl:min-h-[675px] 4xl:min-h-[695px] relative z-10 flex w-full justify-end bg-blue-950 px-4 pt-14 pb-12 md:max-w-[50%] md:items-center md:bg-blue-950/80 lg:bg-blue-950/80 lg:px-12 lg:py-16 xl:py-20 xl:pr-24 xl:pl-16">
          <div className="flex w-fit flex-col items-center gap-8 md:items-start">
            <article className="relative z-20 flex flex-col items-center gap-4 md:max-w-[489px] md:items-start">
